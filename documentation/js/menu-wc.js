                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ErrorToastCTAComponent.html" data-type="entity-link" >ErrorToastCTAComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/VjsPlayerComponent.html" data-type="entity-link" >VjsPlayerComponent</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/DashboardVideoModel.html" data-type="entity-link" >DashboardVideoModel</a>
                            </li>
                            <li class="link">
                                <a href="classes/HeroVideoModel.html" data-type="entity-link" >HeroVideoModel</a>
                            </li>
                            <li class="link">
                                <a href="classes/Validation.html" data-type="entity-link" >Validation</a>
                            </li>
                            <li class="link">
                                <a href="classes/VideoModel.html" data-type="entity-link" >VideoModel</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ToastCTA.html" data-type="entity-link" >ToastCTA</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
